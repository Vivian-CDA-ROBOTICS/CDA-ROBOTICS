...
public class TankDriveProgram extends LinearOpMode {
...
testMotor2.setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.BRAKE);
        ...
        while (opModeIsActive()) {
            ...
            telemetry.addData("epic status:", "left %.2f",leftStick, rightStick );
       
            telemetry.update();
            testMotor1.setPower(leftStick * 0.8);
            testMotor2.setPower(rightStick * -0.8);
